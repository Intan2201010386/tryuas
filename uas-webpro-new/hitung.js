...
buttonHitungNilai.addEventListener("onclick", function(){
    ...
    const nilaiAkhir = () => {
        ...
        nilaiAngka.innerHTML ='<div class="box box-1"> <p class="box-header">Nilai Angka</p><div class="nilaiAngka"><h1>'+hasil+'</h1></div></div>';
        ...
        nilaiHuruf.innerHTML ='<div class="box box-2"><p class="box-header">Nilai Huruf</p><div class="nilaiAngka"><h1>'+grade+'</h1></div>"</div>';
    }
    nilaiAkhir();
